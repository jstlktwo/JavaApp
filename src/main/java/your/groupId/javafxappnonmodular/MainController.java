...
public class MainController {
    ...
    public void saveTheNote(StackPane stackPane) {
        ...
        currentDate = String.valueOf(dst3) + "_" + month.getText() + "_" + year.getText();
    ...
    public void notesOnClick() {
        ...
        FXMLLoader newWindow = new FXMLLoader(MainApplicationLauncher.class.getResource("views/notesList.fxml"));
